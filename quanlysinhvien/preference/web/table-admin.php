        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">XEM THỐNG KÊ CÁC LỚP</h4>
...
<!--                    </div>-->
                    ...
                    <table class="table table-striped">
                      ...
                      if(mysqli_num_rows($result) > 0){
                          ...
                          while ($r = mysqli_fetch_assoc($result)){
                              ...
                              $lop = $r['tenLop'];
                              $siSo= $r['siSo'];
                              $coVanHocTap= $r['coVanHocTap'];
                              // $phongHoc=$r['phonghoc'];

                              if ($idlop != 100){
                                  $diemTB = mt_rand (4*10, 8*10) / 10;
                                  $count++;
                                  echo "
                                      <tr>
                                        <td class=\"py-1\">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Thống kê theo môn</h4>
            ...
            <div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">DANH SÁCH TẤT CẢ SINH VIÊN</h4>
                  <div class="table-responsive pt-4">
                    <table class="table table-bordered">
                      ...
                      if (isset($_POST['tim'])){
                          ...
                          {
                              $query = "SELECT * FROM user WHERE user.hoTen LIKE '%".$giatri."%' or user.id = '$giatri'";
                          }
                      }
                      else{
                      ...
                      if(mysqli_num_rows($result) > 0){
                          ...
                          while ($r = mysqli_fetch_assoc($result)){
                              ...
                              echo "<td>$nienkhoa</td>";
                              echo "<td>$tenlop</td>";;
                              echo " <td style='text-align: center;'> <a href='change-student.php?id=$idSV'><input id='btnSua' type='button' value='SỬA' '></a>   <a href='delete-student.php?id=$idSV'><input id='btnXoa' type='button' value='XÓA'></a> </td>";
                          }
                      }
